...
<head>
  ...
  <title>ML-based AI Governance Vision Predictor</title>
  <style>
    body { font-family: Arial, Helvetica, sans-serif; line-height: 1.45; margin: 28px; max-width: 980px; }
    code, pre { font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, "Liberation Mono", monospace; }
    pre { padding: 12px; border: 1px solid #ddd; border-radius: 8px; overflow-x: auto; background: #fafafa; }
    h1 { margin-bottom: 6px; }
    h2, h3 { margin-top: 22px; }
    .subtitle { color: #555; font-size: 15px; margin-bottom: 18px; }
    .badge { display:inline-block; padding:2px 8px; border:1px solid #ddd; border-radius:999px; margin-right:8px; font-size:12px; }
    .note { border-left: 4px solid #3b82f6; padding: 10px 12px; background: #f4f8ff; border-radius: 8px; }
    .warn { border-left: 4px solid #f59e0b; padding: 10px 12px; background: #fff7ed; border-radius: 8px; }
    ul { margin-top: 8px; }
  </style>
</head>
<body>
